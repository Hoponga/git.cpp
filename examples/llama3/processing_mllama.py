...
# taken from https://github.com/huggingface/transformers/blob/3457e8e73e4f5532cc69059682b1ba4484d7e7e8/src/transformers/models/mllama/processing_mllama.py#L176
...
# try to rewrite the image processor from scratch 
